...
INSTANTIATE_TEST_SUITE_P(ClampCases, ClampAddTest,
                         ::testing::Values(ClampParams{1, 2, -10, 10, 3},
                                           ClampParams{100, 50, -10, 120, 120},
                                           ClampParams{-100, -50, -120, 10, -120},
                                           ClampParams{0, 0, -1, 1, 0}));
